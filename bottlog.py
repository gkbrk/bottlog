...
class apache_logger:
    ...
    def apply(self, callback, route):
        ...
        log_data.append("\"%s %s %s\"".format(bottle.request.method, bottle.request.path, bottle.request.environ.get("SERVER_PROTOCOL", "")))
